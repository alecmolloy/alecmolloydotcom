...
const PerlinNoiseMaterial = shaderMaterial(
  ...
  ` #define PI 3.1415926535
    ...
    void main() {
      vec3 noiseCoord = vec3(floor(vUv * 256.0) / 256.0 * 10.0, time * 0.25);
      ...
      vec2 ditherCoord = floor(vUv * 256.0);
...
export const HeroArtwork = () => (
  <Flex id='hero' justify='center' align='center' height='100vh' width='100vw'>
