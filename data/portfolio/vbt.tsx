...
export const vbt = project(
  ...
  <>
    <Txt>
      The Vijñāna Bhairava Tantra (VBT) is a 9th Century yogic text, offering
      112 practices to access states of expanded awareness and inner stillness.
      While the VBT has been revered for centuries, translation of its spiritual
      depth and practical guidance has been lacking until now. I worked with the
      translator, Hareesh, and Antoine Sakho (Product Advisor) to build this
      forthcoming.
    </Txt>
    <Txt>
  ...
  [
    collaborator('Dr. Christopher Wallace', 'https://sakho.me'),
    collaborator(
      'Antoine Sakho',
