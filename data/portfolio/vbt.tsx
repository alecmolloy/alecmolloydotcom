  ...
  content: (
    <>
      ...
      <p>
        ...
        Vijñāna Bhairava Tantra by Hareesh Wallace, who brings decades of study
        and practice to this work. He leads practitioners into deeper states of
      ...
      <p>
        ...
        TypeScript. The Strapi content management system functions as the
        backend, delivering the text and guided meditations on-demand. Interface
        design, mockups, and prototyping was done with Figma. 112 beautiful
        illustrations were produced with Midjourney and Photoshop for each of
        the practices.
      </p>
      <p>
        ...
        in Fall 2024, the VBT App combines ancient wisdom with modern
        technology, offering a practical, accessible way to explore the rich
        teachings of the Vijñāna Bhairava Tantra.
      </p>
    </>
  ),
  deliverables: 'iOS / Android App, Landing webpage',
  role: 'UX / UI Design, Developer, Artwork',
  collaborators: [
    collaborator(
